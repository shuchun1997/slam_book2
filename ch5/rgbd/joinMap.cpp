...
//该程序一次性读取多张图片的方式,文中是把编译之后的可执行程序放在pose.txt的文件中

using namespace std;
/*
 C++11标准中，aligned_allocator管理C++中的各种数据类型的内存方法是一样的，可以不需要着重写出来。
...
int main(int argc, char **argv) {
    ...
    ifstream fin("/home/shuchun/下载/slambook2-master/ch5/rgbd/pose.txt");   //打开文件
    if (!fin)
    {
